...
<td class="" style="color:#444; font-weight: 400;"><br><br>
 A client has been registered by this name {{$data->full_name}} <br><br>
  You have successfully been registered to use PropTech as a <em>Landlord</em><br>
 <br>
  Your login credentials are provided below:
<br>
<span style="font-weight:bold;">Email: &nbsp;</span><span style="font-weight:lighter;" class="">{{$data->emai}}/span> 
 <br>
  <span style="font-weight:bold;">Password: &nbsp;</span><span style="font-weight:lighter;" class=""></span>
<br><br>  
<br></td>
</tr>
</tbody></table></center>
